...
public class CrimeReport {
   public static void main(String[] args) {
      ...
      sanFrancisco.userDistrictVisit();
   }
}
...
class Data {
   ...
   public void addHomicide(int count) {
        homicide += count;
    }

    public void addRape(int count) {
        rape += count;
    }

    public void addRobbery(int count) {
        robbery += count;
    }

    public void addAssault(int count) {
        assault += count;
    }

    public void addSexTrafficking(int count) {
        sexTrafficking += count;
    }

    public void addBurglary(int count) {
        burglary += count;
    }
    ...
    public void addArson(int count) {
        arson += count;
    }

    public void addLarceny(int count) {
        larceny += count;
    }
}
...
class CrimeData {
   ...
   /*
   public void userAddCrime() {
      String[] crimes = new String[]{"Homicide","Rape","Robbery","Assault","Human Sex Trafficking","Burglary","Vehicle Theft", "Arson", "Larceny Theft"};
      System.out.println("To what district would you like to add a crime?: ");
      ...
      System.out.println("");
      String addDistrict = scan.next();
      System.out.println("What crime would you like to add? Here are a list of crimes:");
      int numCrimes = crimes.length;
      for (int i = 0; i < numCrimes - 1; i++) {
         System.out.print(crimes[i] + ", ");
      }
      System.out.print(crimes[numCrimes - 1]); // print last crime with no comma
      System.out.println("");
      String addCrime = scan.next();                     
   }
   */
     
   public void userDistrictVisit() {
